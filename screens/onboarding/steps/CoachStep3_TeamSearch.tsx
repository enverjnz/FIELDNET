...
export default function CoachStep3_TeamSearch({ data, update, onNext, onBack }: Props) {
  ...
  return (
    ...
    >
      <Text style={styles.title}>Welches Team{'\n'}betreust du?</Text>
      <Text style={styles.subtitle}>
        Suche nach deinem Team. Deine Trainer-Anfrage wird als{' '}
        <Text style={styles.highlight}>ausstehend</Text> eingereicht und vom Admin bestätigt.
      </Text>
      ...
      {!!data.selectedTeamId && (
        <View style={styles.selectedBadge}>
          ...
          <Text style={styles.selectedText}>
            {data.selectedTeamName} – Trainer-Anfrage wird gestellt
          </Text>
        </View>
      )}

      <Text style={styles.skipHint}>
        Du kannst diesen Schritt überspringen und später ein Team anfragen.
      </Text>
